    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a style="float:right;" href="add_user.php" class="btn btn-primary btn-sm btn-round ml-auto float-right"><i class="fa fa-plus"></i> Add new user </a>
              <h6>Users table</h6>
            </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold"><?php echo ucfirst ($value['fname'])?></span>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="form-button-action">
                            <a style="margin-bottom:0px;padding: 7px 9px 7px 9px;" href="view_user.php?id=<?php echo $value['id']?>" class="btn btn-primary btn-sm" value="view_user" data-original-title="view">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                            <a style="margin-bottom:0px;padding: 7px 9px 7px 9px;" href="update_user.php?id=<?php echo $value['id']?>" class="btn btn-primary btn-sm" data-original-title="Edit">
