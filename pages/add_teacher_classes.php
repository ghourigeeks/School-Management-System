            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="row">
                ...
                <div class="form-group">
                        ...
                        <select class="form-control" name="teacher_id" id="teacher_id" aria-label=".form-select-lg example" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                           ...
                           <select class="form-control" name="subject_id" id="subject_id" aria-label=".form-select-lg example" required>
                            <option selected disabled value="">Please Select</option>
                    ...
                    <div class="form-group">
                           ...
                           <select class="form-control" name="time_slot_id" id="time_slot_id" aria-label=".form-select-lg example" required>
                            <option selected disabled value="">Please Select</option>
                            <?php foreach ($timeslot as $key => $value) { ?>
                            <option value="<?php echo $value['id']?>"><?php echo ucwords ($value['start_time'])?></option>
                            <?php }?>
                            </select>
                         </div>
                      </div>
              ...
              <button type="submit" name="submit_btn" value="add_teacher_classes" class="btn btn-success">Submit</button>
