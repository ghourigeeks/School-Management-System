...
if (($_SESSION['users']['role_id'] == 1) OR ($_SESSION['users']['role_id'] == 2)) {
  ...
  header("location:gender.php?error=0");
}
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="row">
                    <div class="col-md-12">
                         <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="name" name="name" value="<?php echo $gender['name'] ?>" placeholder="Gender name" required>
                         </div>
                      </div>
               </div>
               <div class="form-group">
                          ...
                          <?php if($gender['active'] == 1){?>
                          <option value="1" selected>Active</option>
                          <option value="0">Inactive</option>
                          <?php }?>
                          <?php if($gender['active'] == 0){?>
              ...
              <button type="submit" name="submit_btn" value="update_gender" class="btn btn-success">Submit</button>
