  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder text-white mb-0">Classes</h6>
        </nav>
    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a style="float:right;" href="add_class.php" class="btn btn-primary btn-sm btn-round ml-auto float-right"><i class="fa fa-plus"></i> Add new class </a>
              <h6>Classes table</h6>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-button-action">
                            <a style="margin-bottom:0px;padding: 7px 9px 7px 9px;" href="view_class.php?id=<?php echo $value['id']?>" class="btn btn-primary btn-sm" value="view_user" data-original-title="view">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                            <a style="margin-bottom:0px;padding: 7px 9px 7px 9px;" href="update_class.php?id=<?php echo $value['id']?>" class="btn btn-primary btn-sm" data-original-title="Edit">
