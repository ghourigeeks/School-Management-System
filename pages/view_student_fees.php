                        ...
                        <div class="table-responsive">
                              <table class="table dt-responsive">
                                  <tbody><tr>
                                      ...
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $std_fees['id'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Student name</td>
                                      <td><label style="font-size:13px; margin-left:20px;"><?php foreach ($student as $key => $value) { ?>
                                  ...
                                  <tr>
                                      <td>Student fees</td>
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $std_fees['fees'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Created time</td>
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $std_fees['created_at'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Student paid status</td>
                                        <td>
