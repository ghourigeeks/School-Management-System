                    ...
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive">
                              <table class="table dt-responsive">
                                  <tbody><tr>
                                      <td width="80%">Gender id</td>
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $gender['id'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Gender name</td>
                                        <td>
                                        <label style="font-size:13px; margin-left:20px;"><?php echo $gender['name'] ?></label>
                                      </td>
                                    </tr>
                                     <tr>
                                      <td>Gender status</td>
