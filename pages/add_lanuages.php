...
if((isset($_GET['msg'])) && (($_GET['msg']) == true) ){ ?>
	...
	<script>
		alert("Lanuage name maybe already used");
	</script>
              ...
              <div class="row">
                    <div class="col-md-12">
                         <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="name" name="name" placeholder="Lanuage name" required>
                         </div>
                      </div>
               </div>
              </div>
              <div style="margin-top: -20px;" class="card-footer">
              <button type="submit" name="submit_btn" value="add_lanuages" class="btn btn-success">Submit</button>
