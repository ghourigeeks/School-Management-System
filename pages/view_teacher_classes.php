                        ...
                        <div class="table-responsive">
                              <table class="table dt-responsive">
                                  <tbody><tr>
                                      ...
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $tchr_class['id'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Teacher name</td>
                                  ...
                                  <tr>
                                      <td>Teacher subject</td>
                                        <td><label style="font-size:13px; margin-left:20px;"><?php foreach ($subject as $key => $value) { ?>
                                  ...
                                  <tr>
                                      <td>Teacher Class</td>
                                        <td><label style="font-size:13px; margin-left:20px;"><?php foreach ($class as $key => $value) { ?>
                                  ...
                                  <tr>
                                      <td>Enter time</td>
                                        <td><label style="font-size:13px; margin-left:20px;"><?php foreach ($enter_time as $key => $value) { ?>
                                  ...
                                  <tr>
                                      <td>Exit time</td>
                                        <td><label style="font-size:13px; margin-left:20px;"><?php foreach ($end_time as $key => $value) { ?>
                                        <?php if($value['id'] == $tchr_class['time_slot_id']){?>
