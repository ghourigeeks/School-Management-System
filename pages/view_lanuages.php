                    ...
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive">
                              <table class="table dt-responsive">
                                  <tbody><tr>
                                      <td width="80%">Lanuage id</td>
                                      <td><label style="font-size:13px; margin-left:20px;"><?php echo $lanuages['id'] ?></label></td>
                                  </tr>
                                  <tr>
                                      <td>Lanuage name</td>
                                        <td>
                                        <label style="font-size:13px; margin-left:20px;"><?php echo $lanuages['name'] ?></label>
                                      </td>
                                    </tr>
                                     <tr>
                                      <td>Lanuage status</td>
                                        <td>
