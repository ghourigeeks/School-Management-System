        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="row">
                    <div class="col-md-12">
                         <div class="form-group">
                           <label for="name">marital_status name <span style="color:red">*</span></label>
                           <input type="text" class="form-control" id="name" name="name" value="<?php echo $marital_status['name'] ?>" placeholder="Marital status name" required>
                         </div>
                         <div class="form-group">
                          ...
                          <?php }?>
                          <?php if($marital_status['active'] == 0){?>
              ...
              <button type="submit" name="submit_btn" value="update_marital_status" class="btn btn-success">Submit</button>
                <a href="marital_status.php"type="submit" class="btn btn-danger">Cancel</a>
                </div>
              </form>
            </div>
          </div>
