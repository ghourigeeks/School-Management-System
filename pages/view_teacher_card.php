  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder text-white mb-0">Teacher card</h6>
        </nav>
                    ...
                    <div class="id-card">
                      <div class="profile-row">
                        <div class="dp">
                          ...
                          <img src="uploads/<?php echo $getDataById['tchr_pic'] ?>" alt="Image">
                        </div>
                        <div class="desc">
                          <p>Teacher id : <?php echo $getDataById['id']?></p>
                          <p>Teacher name : <?php echo ucfirst($getDataById['name'])?></p>
                          <p>Guardian name : <?php echo ucfirst($getDataById['guardian_name']) ?></p>
                          <p>Date of birth : <?php echo ucfirst($getDataById['date_of_birth']) ?></p>
                          <p>Emerg number : <?php echo ucfirst($getDataById['tel_no']) ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div style="margin-top:10px;" class="id-card-wrapper">
                    <div class="id-card">
                     ...
                     <?php
                          ...
                          $codeContents = ucfirst($getDataById['id']) . ucfirst($getDataById['name']) . ucfirst($getDataById['guardian_name']) . ucfirst($getDataById['date_of_birth']) .  ucfirst($getDataById['tel_no']) ;
