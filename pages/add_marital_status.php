...
if((isset($_GET['msg'])) && (($_GET['msg']) == true) ){ ?>
	...
	<script>
		alert("Marital status name maybe already used");
	</script>
              ...
              <div class="row">
                    <div class="col-md-12">
                         <div class="form-group">
                           <label for="name">marital status name <span style="color:red">*</span></label>
                           <input type="text" class="form-control" id="name" name="name" placeholder="Marital status name" required>
                         </div>
                      </div>
               </div>
              </div>
              <div style="margin-top: -20px;" class="card-footer">
              <button type="submit" name="submit_btn" value="add_marital_status" class="btn btn-success">Submit</button>
