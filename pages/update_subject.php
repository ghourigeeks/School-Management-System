...
if (($_SESSION['users']['role_id'] == 1) OR ($_SESSION['users']['role_id'] == 2)) {
  ...
  header("location:subject.php?error=0");
}
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder text-white mb-0">Subject</h6>
        </nav>
    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a style="float:right;padding: 9px 16px 9px 16px;" href="subject.php" class="btn btn-primary btn-sm btn-round ml-auto float-right"><i class="fa fa-chevron-left"></i></a>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <button type="submit" name="submit_btn" value="update_subject" class="btn btn-success">Submit</button>
                <a href="subject.php"type="submit" class="btn btn-danger">Cancel</a>
                </div>
              </form>
            </div>
          </div>
