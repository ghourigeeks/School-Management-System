            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 style="text-align:center" class="font-weight-bolder">Sign In</h4>
                </div>
                <div class="card-body">
                  <form id="form" role="form">
                <div class="form-group">
                    <label for="username">username <span class="text-danger"> * </span></label>
                    <input type="username" name="username" id="username" autocomplete="off" class="form-control" placeholder="username">
                ...
                <div class="form-group">
					...
					<a style="float:left; font-size:14px;" href="forget.php">Forget password</a>
                      <a href="javascript:void(0)" name="submit_btn" id="submit_btn" type="button" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Login</a>
                    </div>
                  </form>
                </div>
              </div>
  ...
  <script type="text/javascript">
		$(document).ready(function (){
			...
			function validate_all_fields(){
				...
				if( (cus_validate("username")) && (cus_validate("password")) ){
					 	return true;
					}else{
						return false;
					}
